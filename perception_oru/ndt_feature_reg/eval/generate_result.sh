...
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output ransac_s10.txt --skip_matching 
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval1_s10.txt
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval3_s10.txt --estimate_di
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval4_s10.txt --match_no_association
# # #rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval5.txt --match_full
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval6_10.txt --trim_factor=0.9
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval7_s10.txt --trim_factor=0.9 --estimate_di
# # rosrun ndt_feature_reg ndt_feature_eval --association association.txt --support_size=10 --output eval8_s10.txt --max_kp_dist=6
