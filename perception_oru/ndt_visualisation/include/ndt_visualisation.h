...
public:
	...
	void setConfigFile(std::string file) { configFile = file; }
	void setAOK(bool aok_) {aOK = aok_;} // try to avoid

	char getFileFormat() { return fileFormat_; }
	bool getAOK() { return aOK; }
